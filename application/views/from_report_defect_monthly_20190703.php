...
#========================================================================================================================  Put field ====================================================================================        
            if( $sheetIndex == 'defect' ) 
            {
                ...
                $style_layout['di']   = array('CX','DK');
                $style_layout['pe']   = array('DM','DR');
                $style_layout['oh']   = array('DT','EC');
            ...
            #======================================================================== กำหนดขนาด คอลัมป์ ========================================================# 
                 ...
                 $objPHPExcel->getActiveSheet()->getColumnDimension('EF')->setWidth('2.71'); 
                 ...
                 $objPHPExcel->getActiveSheet()->getColumnDimension('B')->setWidth('23.71');    
                    ...
                    foreach (array('R', 'AH', 'EE') as $ind_col ) 
            ...
            #======================================================================== จัดตำแหน่ง ข้อมูล ====================================================================================     
                ...
                //echo date('t F Y', strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) ; exit;
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('E'  . '4', 'DEFECT MONTHLY REPORT');
                 $objPHPExcel->getActiveSheet()->setCellValue('E'  . '7', '( Accumulate Ng ' . date('01 F' , strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) . ' to ' . date('t F', strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) . " )" );
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('B'  . '15', 'DEFECT OF ' . strtoupper( date('F-Y', strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) ) );
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('AC' . $st_col, 'MA + PE'."\n"."(Pcs.)");
                    ...
                    foreach ( range(100,  113) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")");  
                    foreach ( range(115, 120) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")"); 
                    foreach ( range(122, 131) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")"); 
                    ...
                    foreach ( range(100,  113) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );  
                    foreach ( range(115, 120) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' ); 
                    foreach ( range(122, 131) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' ); 
            ...
            #======================================================================== พิเศษ ========================================================================================
                       $objPHPExcel->getActiveSheet()->getStyle('AV2:ED2')->getAlignment()->setTextRotation(-90);
                       $objPHPExcel->getActiveSheet()->getStyle('AV2:ED2')->applyFromArray(array('font' => Style_Font(28,"FF0000",True,False,'Arial Rounded MT Bold')));
                       $objPHPExcel->getActiveSheet()->setCellValue('AV'  . '2', 'RM' );
                       $objPHPExcel->getActiveSheet()->setCellValue('CH'  . '2', 'MA' );
                       $objPHPExcel->getActiveSheet()->setCellValue('CW'  . '2', 'AS' );
                       $objPHPExcel->getActiveSheet()->setCellValue('DL'  . '2', 'PD4');
                       $objPHPExcel->getActiveSheet()->setCellValue('DS'  . '2', 'PE' );
                       $objPHPExcel->getActiveSheet()->setCellValue('ED'  . '2', 'OTHER' );
                       Style_Alignment('AI2:ED2',2, False, $objPHPExcel); 

                            foreach (array('AV', 'CH', 'CW', 'DL', 'DS', 'ED') as $ind_col )  
            ...
            #======================================================================== กำหนด ฟ้อร์น และ สี ==================================================================================== 
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('S15:ED15') ->applyFromArray(array('font' => Style_Font(36,"000000",True,False,'Arial Rounded MT Bold'))); 
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('S19:ED21')->applyFromArray(array('font' => Style_Font(12,"000000",True,False,'Arial Rounded MT Bold')));
            ...
            #======================================================================== กรุป คอลัมป์  ==================================================================================== 
                   ...
                   foreach ( range(32,  132) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 1);                  
                   ...
                   foreach ( range(100,  113) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(115, 120) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(122, 131) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
