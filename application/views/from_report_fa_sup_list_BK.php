     ...
     if(count($list_act_report[$sheetIndex]) > 0 )
         { 
                   ...
                   $objPHPExcel->setActiveSheetIndex($indSheet);
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle(('D'.$st_cal.':'.$col_name[17].$st_cal))
                                ->getAlignment()
                                ->setWrapText(true)
                                ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
                                ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D9:'.$col_name[17].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[17].'6')->applyFromArray(array('fill'    => Style_Fill($colhead)));
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[17].'6')->applyFromArray(array('font'    => Style_Font(10, 'FFFFFF', true, 'Arial Narrow')));
                    $objPHPExcel->getActiveSheet()->getStyle('D9:'.$col_name[17].(count( $list_act_report[$sheetIndex] )+8))->applyFromArray(array('font'    => Style_Font(11, '000000', false, 'Calibri')));
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('D8:'.$col_name[17].'8')->applyFromArray(array('fill'    => Style_Fill('b3cccc')));
                                ...
                                $indCol = 3;
                                        foreach ($val as $rowData => $data) 
                                        {
                                           if($rowData != 'NO')
                                           {
                                            ...
                                            $objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('fill'    => Style_Fill('d9d9d9'))); //color sheet
                                            $objPHPExcel->getActiveSheet()->getRowDimension( $r )->setRowHeight( 20 );
                                            $objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('font'    => Style_Font(12, '000000', true, 'Calibri')));
                                            }

                                            if ($val['STOCK_TODAY'] < $val['PLAN_QTY'] )
                                            {

                                            	$objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('fill'    => Style_Fill('ffffcc')));
                                            	$objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('font'    => Style_Font(11, 'ff0000', false, 'Calibri')));
                                            }
                                            if ($val['SUP_FROM'] == '')
                                            {
                                            	$objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('fill'    => Style_Fill('d9d9d9')));
                                            	$objPHPExcel->getActiveSheet()->getStyle('D'.($r).':'.$col_name[17].($r))->applyFromArray(array('font'    => Style_Font(11, '000000', true, 'Calibri')));
        ...
        //echo $Montlast.$Daylast;exit;
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('R3', "PRODUCTION DATE \n".strtoupper(date('d-M-Y',  strtotime((date('d')+1) . "-" . date('M') . "-" . date('Y')) )));
...
#126180
                      //      $objPHPExcel->getActiveSheet()->getStyle('G2:L2')->applyFromArray(array('font'    => Style_Font(14, '000000', true, 'Calibri')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('B2:'.'S'.($cu_dat+11))->applyFromArray(array(
                                                                     'borders' => array('outline' => Style_border(PHPExcel_Style_Border::BORDER_THICK,'000000'))));
                            $objPHPExcel->getActiveSheet()->getStyle('D9:'.'R'.($cu_dat+9))->applyFromArray(array(
                                                                     'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'c2c2d6'))));
                          

                 

                          $objPHPExcel->getActiveSheet()->getColumnDimension('N')->setVisible(false); //hide
                          ...
                          $objPHPExcel->getActiveSheet()->mergeCells('P3:P4');
                       						  ...
                       						  $objPHPExcel->getActiveSheet()->getStyle('I9'.':J'.( count( $list_act_report[$sheetIndex] )+8) )
