     ...
     if(count($list_act_report[$sheetIndex]) > 0 )
         { 
                   ...
                   $objPHPExcel->setActiveSheetIndex($indSheet);
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle(('D'.$st_cal.':'.$col_name[16].$st_cal))
                                ->getAlignment()
                                ->setWrapText(true)
                                ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
                                ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
                    ...
                    $objPHPExcel->getActiveSheet()->setAutoFilter('D8:'.$col_name[16].'8');
                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D5:'.$col_name[16].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D6:'.$col_name[16].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
                    ...
                    $objPHPExcel->getActiveSheet()->setAutoFilter('D8:'.$col_name[16].'8');
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[16].'6')->applyFromArray(array('fill'    => Style_Fill('009999')));
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[16].'6')->applyFromArray(array('font'    => Style_Font(10, '000000', true, 'Calibri')));  

                    $objPHPExcel->getActiveSheet()->getStyle('J5:W5')->applyFromArray(array('font'    => Style_Font(12, '000000', true, 'Calibri')));      
                    $objPHPExcel->getActiveSheet()->getStyle('D9:'.$col_name[16].(count( $list_act_report[$sheetIndex] )+8))->applyFromArray(array('font'    => Style_Font(12, '000000', false, 'Calibri')));
                //   $objPHPExcel->getActiveSheet()->setCellValue('J6', 'STOCK TODAY');
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[16].'7')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));
                    $objPHPExcel->getActiveSheet()->getStyle("A1")->getFont()->setBold(true)
                                ->setName('Consolas')
                                ->setSize(11)
                                ->getColor()->setRGB('FFFFFF');

                     $objPHPExcel->getActiveSheet()->getStyle('H3:Q3')->applyFromArray(array('font'    => Style_Font(16, '000000', true, 'Browallia New'))); 
                     $objPHPExcel->getActiveSheet()->getStyle('H2:Q2')->applyFromArray(array('font'    => Style_Font(16, '0086b3', true, 'Browallia New')));  
                     ...
                     // $objPHPExcel->getActiveSheet()->getStyle('L4:O4')->applyFromArray(array('fill' => Style_Fill('dce6f1')));
                    // $objPHPExcel->getActiveSheet()->getStyle('K2:K3')->applyFromArray(array('fill' => Style_Fill('ccffff')));           
                    // $objPHPExcel->getActiveSheet()->getStyle('L2:O2')->applyFromArray(array('fill' => Style_Fill('d9ffcc')));
                    // $objPHPExcel->getActiveSheet()->getStyle('L3:O3')->applyFromArray(array('fill' => Style_Fill('d9ffcc')));
                    // $objPHPExcel->getActiveSheet()->getStyle('P2:Q2')->applyFromArray(array('fill' => Style_Fill('ffd9cc')));
                    // $objPHPExcel->getActiveSheet()->getStyle('P3:Q3')->applyFromArray(array('fill' => Style_Fill('ffd9cc')));

                //     $objPHPExcel->getActiveSheet()->getStyle('Q5:V5')->applyFromArray(array('fill' => Style_Fill('9fbfdf')));


                    $objPHPExcel->getActiveSheet()->setCellValue('K2', "Production QTY"); 
                    $objPHPExcel->getActiveSheet()->setCellValue('L2', "Production Time [min]"); 
                    $objPHPExcel->getActiveSheet()->setCellValue('D2', "Production Cost Report"); 
                //    $objPHPExcel->getActiveSheet()->setCellValue('Q3', "ACT NORMAL :"); 
               ...
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('Q4', "ACT OT :");
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('S4', "pcs."); 
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('T1', "ACCUM MAN :");
                   
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('V1', "man."); 
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('T2', "TOTAL TIME :");
                  
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('V2', "mins."); 
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('T3', "WORK TIME :");
       
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('V3', "mins."); 
               //   //    $objPHPExcel->getActiveSheet()->setCellValue('T4', "OT TIME :");
               //       $objPHPExcel->getActiveSheet()->setCellValue('R5', '=SUBTOTAL(9,R9:R'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
               //       $objPHPExcel->getActiveSheet()->setCellValue('W5', '=SUBTOTAL(9,W9:W'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('P1', "mins."); 
               //  //     $objPHPExcel->getActiveSheet()->setCellValue('N1', "Man Hr Pcs \n by PD."); 


                     // $sumplan = '(SUBTOTAL(9,M9:M'. (count( $list_act_report[$sheetIndex] )+8) . '))';
                     // $sumactualot = '(SUBTOTAL(9,P9:P'. (count( $list_act_report[$sheetIndex] )+8) . '))';
                     // $sumloss = '(SUBTOTAL(9,Q9:Q'. (count( $list_act_report[$sheetIndex] )+8) . '))';
                     // $sumtotaltime  = '(SUBTOTAL(9,R9:R'. (count( $list_act_report[$sheetIndex] )+8) . '))';
                     // $sumactual  = '(SUBTOTAL(9,N9:N'. (count( $list_act_report[$sheetIndex] )+8) . '))';
                     // $sumtotalwork  = '(SUBTOTAL(9,W9:W'. (count( $list_act_report[$sheetIndex] )+8) . '))';

                     // $objPHPExcel->getActiveSheet()->setCellValue('S5', '=('.$sumloss.'+'.$sumtotaltime.')/'.$sumactual);
           
                     // $objPHPExcel->getActiveSheet()->setCellValue('T5', '=('.$sumtotaltime.'/'.$sumactual.')');

                        
                     $objPHPExcel->getActiveSheet()->getStyle('D8:'.$col_name[16].'8')->applyFromArray(array('fill'    => Style_Fill('b3cccc')));
...
#126180
                      //      $objPHPExcel->getActiveSheet()->getStyle('G2:L2')->applyFromArray(array('font'    => Style_Font(14, '000000', true, 'Calibri')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('D9:'.'Q'.($cu_dat+9))->applyFromArray(array(
                          ...
                          $objPHPExcel->getActiveSheet()->mergeCells('D4:G4');
                           ...
                           $objPHPExcel->getActiveSheet()->getStyle('J3:Q3')->getFont()->setUnderline(true);
                          ...
                          $objPHPExcel->getActiveSheet()->getStyle('M3'.':N3'.( count( $list_act_report[$sheetIndex] )+8) )
                                                          ->getNumberFormat()->setFormatCode('_* #,##0_-;[Red](#,##0)_-;[Black]_* "-"??_-;_-@_-');                              
                          ...
                          $objPHPExcel->getActiveSheet()->getStyle('O3'.':O'.( count( $list_act_report[$sheetIndex] )+8) )
                                                         ->getNumberFormat()->setFormatCode('_* #,##0_-;[Red](#,##0)_-;[Black]_* "-"??_-;_-@_-'); 
