...
#========================================================================================================================  Put data ====================================================================================                
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('C3', 'RECEIVING REPORT');
                $objPHPExcel->getActiveSheet()->setCellValue('C5',  date('F Y'));
...
$objPHPExcel->getActiveSheet()->getStyle('L'.'9')
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('J3:'.'O3');
