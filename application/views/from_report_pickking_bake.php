...
#========================================================================================================================  Put field ====================================================================================        
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'P2:T5' )
                                              ->applyFromArray(array(
                                                'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'000000')))); 
                 ...
                 Style_Alignment('H1:T5',3, false, $objPHPExcel);
                 Style_Alignment('G3',3, false, $objPHPExcel);

                 Style_Alignment( 'B'.$st_dat.':'.$col_name[5].$count_data ,3, false, $objPHPExcel);
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'P2:T5' )
                 ...
                 $objPHPExcel->getActiveSheet()->getStyle('B'.($count_data+2) .":".'B'.($count_data+9))->applyFromArray(array('font' => Style_Font(12,"000000",true,false)));

                 $objPHPExcel->getActiveSheet()->getStyle('G3')->applyFromArray(array('font' => Style_Font(28,"000000",true,false)));


                 $objPHPExcel->getActiveSheet()->getStyle('B8:T8')->applyFromArray(array('font' => Style_Font(18,"000000",true,false)));
                 $objPHPExcel->getActiveSheet()->getStyle('H8:T8')->applyFromArray(array('font' => Style_Font(12,"000000",true,false)));
                 ...
                 foreach( array( array(7,9), array(10,12), array(13,15), array(16,18) )  as  $ty )
                 {
                 ...
                 foreach( array(1, 2, 3, 4, 5,6, $count_index)  as  $ty )
                 {
...
//exit;
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[7] . 8, "( PERIOD 1-2 ) 05:00 น. - 10:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[10] . 8, "( PERIOD 3-4 ) 13:00 น. - 16:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[13]. 8, "( PERIOD 5-6 ) 18:00 น. - 19:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[16]. 8, "( PERIOD 7-8 ) 20:00 น. - 00:00 น.");
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('G3', "ลูกค้า  ".$de_cust);

                 $objPHPExcel->getActiveSheet()->setCellValue('P4', 'CHECKDOCUMENTS BY'."\n".'เช็คเอกสารโดย');

                 $objPHPExcel->getActiveSheet()->setCellValue('R4', 'PART / FG PREPARED BY'."\n".'จัดเตรียมงาน / จัดส่งโดย');
                 $objPHPExcel->getActiveSheet()->setCellValue('T4', 'APPROVE BY'."\n".'อนุมติโดย');

                 $objPHPExcel->getActiveSheet()->getStyle('P4:T4')->getAlignment()->setWrapText(true);
                 ...
                 $objPHPExcel->getActiveSheet()->getStyle( 'G'.$st_dat.':'.$col_name[$count_index].$count_data )
                ...
                //$objPHPExcel->getActiveSheet()->getColumnDimension($col_name[$count_index])->setWidth('2.71');     #A
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[1])->setWidth('27.71');
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[2])->setWidth('27.71');     #B no
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[3])->setWidth('38.71');    #I model
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[4])->setWidth('20.71');    #J
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[5])->setWidth('27.71');    #K
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[6])->setWidth('14.71');    #K
               ...
               //  $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[($count_index+5)])->setWidth('3.71');    #N                
                 foreach(range(6, ($count_index-1) ) as $r)
               ...
               $objPHPExcel->getActiveSheet()->mergeCells('R2:'.'S3');
               $objPHPExcel->getActiveSheet()->mergeCells('R4:'.'S5');
