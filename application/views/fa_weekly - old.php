     ...
     if(count($list_act_report[$sheetIndex]) > 0 )
         { 
                   ...
                   $objPHPExcel->setActiveSheetIndex($indSheet);
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle(('D'.$st_cal.':'.$col_name[52].$st_cal))
                                ->getAlignment()
                                ->setWrapText(true)
                                ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
                                ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
                    ...
                    $objPHPExcel->getActiveSheet()->setAutoFilter('D8:'.$col_name[52].'8');


                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D5:'.$col_name[52].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D6:'.$col_name[52].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
            ...
            //        $objPHPExcel->getActiveSheet()->setAutoFilter('D8:'.$col_name[53].'8');
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[52].'6')->applyFromArray(array('fill'    => Style_Fill($colhead)));
                 //   $objPHPExcel->getActiveSheet()->getStyle('V6:'.$col_name[52].'6')->applyFromArray(array('fill'    => Style_Fill('00ffcc')));

                    $objPHPExcel->getActiveSheet()->getStyle('V6:'.$col_name[52].'6')->applyFromArray(array('font'    => Style_Font(10, '000000', true, 'Calibri'))); 


                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[52].'6')->applyFromArray(array('font'    => Style_Font(10, 'FFFFFF', true, 'Calibri')));  

                    $objPHPExcel->getActiveSheet()->getStyle('J5:BA5')->applyFromArray(array('font'    => Style_Font(12, '000000', true, 'Calibri')));      
                    $objPHPExcel->getActiveSheet()->getStyle('D9:'.$col_name[52].(count( $list_act_report[$sheetIndex] )+8))->applyFromArray(array('font'    => Style_Font(11, '000000', false, 'Calibri')));
                //   $objPHPExcel->getActiveSheet()->setCellValue('J6', 'STOCK TODAY');
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[52].'7')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));
                    $objPHPExcel->getActiveSheet()->getStyle("A1")->getFont()->setBold(true)
                      ...
                      $objPHPExcel->getActiveSheet()->getStyle('V3:BA3')->applyFromArray(array('fill' => Style_Fill('b3d9ff')));

                      $objPHPExcel->getActiveSheet()->getStyle('M3:P3')->applyFromArray(array('fill' => Style_Fill('ccccff')));  
                      $objPHPExcel->getActiveSheet()->getStyle('M4:P4')->applyFromArray(array('fill' => Style_Fill('ccccff'))); 

                      $objPHPExcel->getActiveSheet()->getStyle('L3:L4')->applyFromArray(array('fill' => Style_Fill('ffcccc'))); 
                      $objPHPExcel->getActiveSheet()->getStyle('Q3:Q4')->applyFromArray(array('fill' => Style_Fill('ffcc99')));
                    // $objPHPExcel->getActiveSheet()->getStyle('Q5:W5')->applyFromArray(array('fill' => Style_Fill('b3d9ff')));
                    
                    //====================================================================================================================================//

                      $TOTAL_TIME_ALLMAN = 'SUBTOTAL(9,O9:O'. (count( $list_act_report[$sheetIndex] )+5) . ")";
                      $ACTUAL = 'SUBTOTAL(9,L9:L'. (count( $list_act_report[$sheetIndex] )+5) . ")";
                      $objPHPExcel->getActiveSheet()->setCellValue('Q4', '=('.$TOTAL_TIME_ALLMAN.')/'.$ACTUAL);
                    ...
                    //====================================================================================================================================//
                     ...
                     $objPHPExcel->getActiveSheet()->getStyle('D8:'.$col_name[52].'8')->applyFromArray(array('fill'    => Style_Fill('b3cccc')));
        ...
        //echo $Montlast.$Daylast;exit;
                            $objPHPExcel->getActiveSheet()->setCellValue('D2', "FA WEEKLY REPORT OF ".$M);
                       //     $objPHPExcel->getActiveSheet()->setCellValue('D4', "Data of : (  01 ".strtoupper($M)." - ".$Daylast." ".strtoupper($M)."  )");
                        //    $objPHPExcel->getActiveSheet()->setCellValue('D4'  . '4', '( Data of : ' . date('01 F') . ' to ' . date('d F', strtotime("- 1 day") ) . " )" );
                        ...
                        //    $objPHPExcel->getActiveSheet()->setCellValue('D3', "FA SUMMARY REPORT OF " .strtoupper(date('d-M-Y',  strtotime((date('d')+1) . "-" . date('M') . "-" . date('Y')) ))); //('D2', "FA Supply list of ".$Montlast);
                             ...
                             $objPHPExcel->getActiveSheet()->setCellValue('V3', "Accum Loss Time [min] ");
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('L3', "Actual QTY");
                            $objPHPExcel->getActiveSheet()->setCellValue('M3', "Production Time (Min)");
                            $objPHPExcel->getActiveSheet()->setCellValue('Q3', "MANHOUR/PCS");


                             

                            $objPHPExcel->getActiveSheet()
                                ->getStyle(('D3'.':'.$col_name[52].'3'))
                                ->getAlignment()
                                ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
                                ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
...
#126180
                      //      $objPHPExcel->getActiveSheet()->getStyle('G2:L2')->applyFromArray(array('font'    => Style_Font(14, '000000', true, 'Calibri')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('V3')->applyFromArray(array('font'    => Style_Font(24, '000000', true, 'Calibri')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('L4:Q4')->applyFromArray(array('font'    => Style_Font(16, '000000', true, 'Browallia New')));     
                            $objPHPExcel->getActiveSheet()->getStyle('V4:BA4')->applyFromArray(array('font'    => Style_Font(16, '000000', true, 'Browallia New')));
                            $objPHPExcel->getActiveSheet()->getStyle('V5:BA5')->applyFromArray(array('font'    => Style_Font(16, '006699', true, 'Browallia New'))); 
                            $objPHPExcel->getActiveSheet()->getStyle('V7:BA7')->applyFromArray(array('font'    => Style_Font(12, '000000', true, 'Browallia New')));     
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('D9:'.'BA'.($cu_dat+9))->applyFromArray(array(
                                                                     'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'c2c2d6'))));


                            $objPHPExcel->getActiveSheet()->getStyle('V7:BA7')->getAlignment()->setTextRotation(90); 
                            $objPHPExcel->getActiveSheet()->getStyle('L4:Q4')->getFont()->setUnderline(true);
                            $objPHPExcel->getActiveSheet()->getStyle('V4:BA4')->getFont()->setUnderline(true);
                      ...
                      //    $objPHPExcel->getActiveSheet()->mergeCells('Q3:Q4');
                          ...
                          $objPHPExcel->getActiveSheet()->mergeCells('V3:BA3');
                          ...
                          $objPHPExcel->getActiveSheet()->getStyle('Q4'.':P'.( count( $list_act_report[$sheetIndex] )+8) )
                                                          ->getNumberFormat()->setFormatCode('_(* #,##0_);_(* (#,##0);_(* "-"_);_(@_)');

                          $objPHPExcel->getActiveSheet()->getStyle('Q4'.':U4'.( count( $list_act_report[$sheetIndex] )+8) )
                                                          ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');

                          $objPHPExcel->getActiveSheet()->getStyle('V4'.':BA4'.( count( $list_act_report[$sheetIndex] )+8) )
                                                          ->getNumberFormat()->setFormatCode('_(* #,##0_);_(* (#,##0);_(* "-"??_);_(@_)');
                          ...
                          // $objPHPExcel->getActiveSheet()->getStyle('P1'.':P'.( count( $list_act_report[$sheetIndex] )+8) )
                          //                                ->getNumberFormat()->setFormatCode('_-* #,##0_-;[Red](#,##0)_-;_-* "-"??_-;_-@_-');   
      ...
      //       foreach (range(12, 22) as $index) Style_group_lv1();                                              
            ...
            //============================================================ Uhide accumm loss ======================================================================//
                        ...
                        //    $objPHPExcel->getActiveSheet()->setCellValue('Q4', '=SUBTOTAL(9,Q9:Q'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('V4', '=SUBTOTAL(9,V9:V'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
                            $objPHPExcel->getActiveSheet()->setCellValue('W4', '=SUBTOTAL(9,W9:W'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
                            $objPHPExcel->getActiveSheet()->setCellValue('X4', '=SUBTOTAL(9,X9:X'. (count( $list_act_report[$sheetIndex] )+8) . ")" );
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('V7:'.'BA'.($cu_dat+9))->applyFromArray(array(
                                                                     'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'c2c2d6'))));

                            $objPHPExcel->getActiveSheet()->getStyle('V2:'.'BA'.($cu_dat+11))->applyFromArray(array(
                                                                     'borders' => array('outline' => Style_border(PHPExcel_Style_Border::BORDER_THICK,'5c8a8a'))));
                             ...
                             //                                         'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'e0ebeb'))));
                              ...
                              $objPHPExcel->getActiveSheet()->setCellValue('V7' , "Meeting"); 
                              $objPHPExcel->getActiveSheet()->setCellValue('W7' , "Cleaning, 5S");
                              $objPHPExcel->getActiveSheet()->setCellValue('X7' , "Planned Maintenance (PM) - in Plan");
                              $objPHPExcel->getActiveSheet()->setCellValue('Y7' , "Planned Maintenance (PM) - out Plan");
                              $objPHPExcel->getActiveSheet()->setCellValue('Z7' , "Training Operator");
                              $objPHPExcel->getActiveSheet()->setCellValue('AA7', "Regular Machine Daily Check / Lot no. change/ Safety co-check");
                              $objPHPExcel->getActiveSheet()->setCellValue('AB7', "Stop adding Flux. / Melting furnance problem");
                              $objPHPExcel->getActiveSheet()->setCellValue('AC7', "Stop Heat up.");
                              $objPHPExcel->getActiveSheet()->setCellValue('AD7', "Mold Clearning ");
                              $objPHPExcel->getActiveSheet()->setCellValue('AE7', " Model,Mold Change - in Plan ");
                              $objPHPExcel->getActiveSheet()->setCellValue('AF7', " Model,Mold Change - out Plan");
                              $objPHPExcel->getActiveSheet()->setCellValue('AG7', " Tooling/Tip/Sleeve - on Plan");
                              $objPHPExcel->getActiveSheet()->setCellValue('AH7', "Waiting for material from inhouse");
                              $objPHPExcel->getActiveSheet()->setCellValue('AI7', "Coolant, Lubrication, Metal Chip Cleaning");
                              $objPHPExcel->getActiveSheet()->setCellValue('AJ7', "Break Down - Machine ");
                              $objPHPExcel->getActiveSheet()->setCellValue('AK7', "Break Down - Mold (Die Casting)");
                              $objPHPExcel->getActiveSheet()->setCellValue('AL7', "Break Down - JIG /Tip/Sleeve");
                              $objPHPExcel->getActiveSheet()->setCellValue('AM7', "Break Down - Tooling");
                              $objPHPExcel->getActiveSheet()->setCellValue('AN7', "Adjust Program and Condition.");
                              $objPHPExcel->getActiveSheet()->setCellValue('AO7', "Adjustment - Mold (Die Casting)");
                              $objPHPExcel->getActiveSheet()->setCellValue('AP7', "Electricity, Air, Utility Break Down");
                              $objPHPExcel->getActiveSheet()->setCellValue('AQ7', "Waiting for material from store");
                              $objPHPExcel->getActiveSheet()->setCellValue('AR7', "Material/Part Quality Problem");
                              $objPHPExcel->getActiveSheet()->setCellValue('AS7', "Personel Reason (toilet,sick,late other)");
                              $objPHPExcel->getActiveSheet()->setCellValue('AT7', "Quality Judgement");
                              $objPHPExcel->getActiveSheet()->setCellValue('AU7', "Waiting data from QC/4M");
                              $objPHPExcel->getActiveSheet()->setCellValue('AV7', "Waiting for Packaging/Box/Partition");
                              $objPHPExcel->getActiveSheet()->setCellValue('AW7', "PE/CE Trial request (CE, PE)/Audit");
                              $objPHPExcel->getActiveSheet()->setCellValue('AX7', "TPM, Line Kaizen");
                              $objPHPExcel->getActiveSheet()->setCellValue('AY7', "Waiting for supervisor");
                              $objPHPExcel->getActiveSheet()->setCellValue('AZ7', "Production of work other than direct production.");
                              $objPHPExcel->getActiveSheet()->setCellValue('BA7', "Re - washing FG part");
            ...
            //============================================================ % loss time ======================================================================//
                         ...
                         foreach (range(21, 52) as $key) 

                           $objPHPExcel->getActiveSheet()->setCellValue($col_name[$key].'5', '=IFERROR( '.$col_name[$key].'4'.'/$'.'P4'. ',0)');   //Iferror 0/0
                           $objPHPExcel->getActiveSheet()->getStyle('V5:BA5')->getNumberFormat()->setFormatCode('_*#,##0.00%_-;[Red](#,##0%)_-;_-* "-"??_-;_-@_-');   
