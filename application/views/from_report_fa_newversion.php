...
if ($til == 'Fa report') {
        ...
        //  $objPHPExcel->getActiveSheet()->getStyle('K1:M'.(count( $list_act_report[$sheetIndex] )+5) )->getNumberFormat()->setFormatCode('_-* #,##0_-;[RED](#,##0)_-;_-* "-"??_-;_-@_-');
         ...
         $objPHPExcel->getActiveSheet()->getStyle('T1:AP'.(count( $list_act_report[$sheetIndex] )+5) )->getNumberFormat()->setFormatCode('_-* #,##0_-;[RED](#,##0)_-;_-* "-"??_-;_-@_-');
...
//exit;
                    $objPHPExcel->getActiveSheet()->insertNewRowBefore(1,2);
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('AA2', "TOTAL_TIME");
                         //   $objPHPExcel->getActiveSheet()->setCellValue('AB2', "EFF (%)");
                            $objPHPExcel->getActiveSheet()->setCellValue('AC2',"WORK_TIME");
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('AE1:AP1')->applyFromArray(array('font' => Style_Font(18,'000000',true)));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('AE1:AP1')->applyFromArray(array('fill'=> Style_Fill('b3cce6'))); //00b3b3
                            $objPHPExcel->getActiveSheet()->getStyle('AE2:AP2')->applyFromArray(array('fill' => Style_Fill('b3cce6'))); //33cccc
                            $objPHPExcel->getActiveSheet()->getStyle('Z2:AA2')->applyFromArray(array('font' => Style_Font(8,'000000',true)));
                            $objPHPExcel->getActiveSheet()->getStyle('AB2:AD2')->applyFromArray(array('font' => Style_Font(8,'000000',true)));
          ...
          $objPHPExcel->getActiveSheet()->getStyle('A1:AP2')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));

          //  $objPHPExcel->getActiveSheet()->getStyle('L2:M2')->getNumberFormat()->setFormatCode('_(* #,##0.00_);_(* (#,##0.00);_(* "-"??_);_(@_)');
          // $objPHPExcel->getActiveSheet()->getStyle('N2:P2')->getNumberFormat()->setFormatCode('_(* #,##0_);_(* (#,##0);_(* "-"_);_(@_)');
    //     $objPHPExcel->getActiveSheet()->getStyle('P')->getNumberFormat()->setFormatCode('_-* #,##0_-;[RED](#,##0)_-;_-* "-"??_-;_-@_-');
         ...
         // $objPHPExcel->getActiveSheet()->getStyle('R2:S2')->getNumberFormat()->setFormatCode('hh:mm:ss');
          $objPHPExcel->getActiveSheet()->getStyle('T2:AP2')->getNumberFormat()->setFormatCode('_-* #,##0_-;[RED](#,##0)_-;_-* "-"??_-;_-@_-'); //IMPORT
     ...
     $objPHPExcel->getActiveSheet()->setCellValue('AE3', "[G]\n Model,Mold Change - in Plan");
          ...
          $objPHPExcel->getActiveSheet()->setCellValue('AJ3', "[K3]\n Break Down - Tooling");
          $objPHPExcel->getActiveSheet()->setCellValue('AK3', "[L]\n Adjust Program and Condition.");
          $objPHPExcel->getActiveSheet()->setCellValue('AL3', "[N]\n Waiting for material from store");
          $objPHPExcel->getActiveSheet()->setCellValue('AM3', "[O]\n Material/Part Quality Problem");
          $objPHPExcel->getActiveSheet()->setCellValue('AN3', "[Q]\n Quality Judgement");
          $objPHPExcel->getActiveSheet()->setCellValue('AO3', "[Q1]\n Waiting data from QC/4M");
          $objPHPExcel->getActiveSheet()->setCellValue('AP3', "[S]\n PE/CE Trial");

          // $objPHPExcel->getActiveSheet()->setCellValue('AE3', "[G]\n Model,Mold Change - in Plan");
          // $objPHPExcel->getActiveSheet()->setCellValue('AF3', "[H]\n Tooling/Lot no.change/Tip/Sleeve - on Plan");
          // $objPHPExcel->getActiveSheet()->setCellValue('AG3', "[K]\n Break Down - Machine ");
          // $objPHPExcel->getActiveSheet()->setCellValue('AH3', "[K1]\n Break Down - Mold");
          // $objPHPExcel->getActiveSheet()->setCellValue('AI3', "[K3]\n Break Down - Tooling");
          // $objPHPExcel->getActiveSheet()->setCellValue('AJ3', "[L]\n Adjust Program and Condition.");
          // $objPHPExcel->getActiveSheet()->setCellValue('AK3', "[N]\n Waiting for material from store");
          // $objPHPExcel->getActiveSheet()->setCellValue('AL3', "[O]\n Material/Part Quality Problem");
          // $objPHPExcel->getActiveSheet()->setCellValue('AM3', "[Q]\n Quality Judgement");
          // $objPHPExcel->getActiveSheet()->setCellValue('AN3', "[Q1]\n Waiting data from QC/4M");
          // $objPHPExcel->getActiveSheet()->setCellValue('AO3', "[S]\n PE/CE Trial");
...
// #---------------------------------------------------------------------------EFF % WORKING TIME----------------------------------------------------------------
    ...
    //      $objPHPExcel->getActiveSheet()->getColumnDimension('AA')->setVisible(false);
       ...
       //   $objPHPExcel->getActiveSheet()->mergeCells('Z2:AA2');
          $objPHPExcel->getActiveSheet()->mergeCells('AE1:AP1');
