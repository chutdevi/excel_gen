...
//exit;
                    $objPHPExcel->getActiveSheet()->insertNewRowBefore(1,2);
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('AD1:AP1')->applyFromArray(array('font' => Style_Font(18,'000000',true)));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('AD1:AP1')->applyFromArray(array('fill'=> Style_Fill('b3cce6'))); //00b3b3
                            $objPHPExcel->getActiveSheet()->getStyle('AD2:AP2')->applyFromArray(array('fill' => Style_Fill('b3cce6'))); //33cccc
         ...
         // $objPHPExcel->getActiveSheet()->getStyle('R2:S2')->getNumberFormat()->setFormatCode('hh:mm:ss');
          ...
          $objPHPExcel->getActiveSheet()->setCellValue('AF3', "[I]\n Waiting for material from inhouse");
...
// #-------------------------------------------------------------------------------------------------------------------------------------------
       ...
       //   $objPHPExcel->getActiveSheet()->getStyle('AA2:AA'.(count( $list_act_report[$sheetIndex] )+5))->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');
        $objPHPExcel->getActiveSheet()->getStyle('AD2:AP'.(count( $list_act_report[$sheetIndex] )+5))->getNumberFormat()->setFormatCode('_-* #,##0_-;[Red](#,##0)_-;_-* "-"??_-;_-@_-');
...
// #---------------------------------------------------------------------------EFF % WORKING TIME----------------------------------------------------------------
    ...
    //      $objPHPExcel->getActiveSheet()->getColumnDimension('AA')->setVisible(false);
       ...
       //   $objPHPExcel->getActiveSheet()->mergeCells('Z2:AA2');
          $objPHPExcel->getActiveSheet()->mergeCells('AD1:AP1');
