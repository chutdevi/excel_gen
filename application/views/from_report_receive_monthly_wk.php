...
#========================================================================================================================  Put field ====================================================================================        
            if( $sheetIndex == 'receive_monthly' ) 
            {
                ...
                foreach (range(5,8) as $id) {  $objPHPExcel->getActiveSheet()->getRowDimension( $id )->setRowHeight( 25 ); }
                // $objPHPExcel->getActiveSheet()->getRowDimension( 7 )->setRowHeight( 30 );
                $objPHPExcel->getActiveSheet()->getRowDimension( 9 )->setRowHeight( 32 );
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B2:'.$col_name[$count_index].($count_data+1))
                                              ->applyFromArray(array(
                                                'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'0f243e')))); 
...
#========================================================================================================================  Put data ====================================================================================                
                    ...
                    foreach ($value as $body => $val) 
                    {
                            ...
                            if ( ($body == 'PRICE_AMOUNT' && $value[$body] > 0) || ( $body == 'PLAN_AMOUNT' && $value[$body] > 0) ) 
                            {
                                    if ($value['SOURCE_CD'] == 'T00100' || $value['SOURCE_CD'] == 'M50050' || $value['SOURCE_CD'] == 'T10400' ) {
                                       ...
                                       // $amt = $val * $rate[2]['CURRENCY_RATE'];
                                        ...
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)
                                                                                                 ->applyFromArray(array('font' => Style_Font1(11, '009900', false, 'Consolas')));                                                   
                                    ...
                                    elseif ($value['SOURCE_CD'] == 'M50030' || $value['SOURCE_CD'] == 'M50040' || $value['SOURCE_CD'] == 'M5004A' || $value['SOURCE_CD'] == 'M5004B' || $value['SOURCE_CD'] == 'M5004C' || $value['SOURCE_CD'] == 'T10200' || $value['SOURCE_CD'] == 'T10300'){
                                        ...
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[RED](#,##0)_-;_-* [BLACK]"-"??_-;_-@_-');
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)
                                                                                                 ->applyFromArray(array('font' => Style_Font1(11, '006600', false, 'Consolas')));                                                   
                                        ...
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[RED](#,##0)_-;_-* [BLACK]"-"??_-;_-@_-');
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)
                                                                                                 ->applyFromArray(array('font' => Style_Font1(11, '0000CC', false, 'Consolas')));                                                   
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('E5', 'WEEKLY FORECAST RECEIVING REPORT');
                $objPHPExcel->getActiveSheet()->setCellValue('E7',  date('F Y') . " to " . date('F Y', strtotime("+ 1 month", strtotime(date('Y-m-01') ) ) ) );
                $objPHPExcel->getActiveSheet()->setCellValue('J3',  'SUMMARY TOTAL');
                $objPHPExcel->getActiveSheet()->setCellValue('J5',  'PLAN');
                $objPHPExcel->getActiveSheet()->setCellValue('J6',  'PRICE AMOUNT');
                $objPHPExcel->getActiveSheet()->setCellValue('J7',  'PLAN NEXT MONTH');
                $objPHPExcel->getActiveSheet()->setCellValue('J8',  'PRICE NEXT MONTH');

                $objPHPExcel->getActiveSheet()->setCellValue('L5',  "=SUBTOTAL(9,J". $st_dat .":J".$count_data.")");
                $objPHPExcel->getActiveSheet()->setCellValue('L6',  "=SUBTOTAL(9,K". $st_dat .":K".$count_data.")");
                $objPHPExcel->getActiveSheet()->setCellValue('L7',  "=SUBTOTAL(9,L". $st_dat .":L".$count_data.")");
                $objPHPExcel->getActiveSheet()->setCellValue('L8',  "=SUBTOTAL(9,M". $st_dat .":M".$count_data.")");
...
//                 $objPHPExcel->getActiveSheet()->setCellValue('L9',  "=SUBTOTAL(9,O". $st_dat .":O".$count_data.")");
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('M5',  "Pcs.");
                $objPHPExcel->getActiveSheet()->setCellValue('M6',  "Thb.");
                $objPHPExcel->getActiveSheet()->setCellValue('M7',  "Pcs.");
                $objPHPExcel->getActiveSheet()->setCellValue('M8',  "Thb.");
                ...
                $objPHPExcel->getActiveSheet()->getStyle('E5')->applyFromArray(array('font' => Style_Font(28,"091625",true)));               
                $objPHPExcel->getActiveSheet()->getStyle('E7')->applyFromArray(array('font' => Style_Font(22,"1f497d",true)));
                $objPHPExcel->getActiveSheet()->getStyle('J3')->applyFromArray(array('font' => Style_Font1(24,"ffffff",true)));
                $objPHPExcel->getActiveSheet()->getStyle('J5:M8')->applyFromArray(array('font' => Style_Font1(14,"002060",true)));
                $objPHPExcel->getActiveSheet()->getStyle('L5')->applyFromArray(array('font' => Style_Font1(14,"ffff00",true)));
                $objPHPExcel->getActiveSheet()->getStyle('L6')->applyFromArray(array('font' => Style_Font1(14,"ffff00",true)));
                $objPHPExcel->getActiveSheet()->getStyle('L7')->applyFromArray(array('font' => Style_Font1(14,"ffff00",true)));
                $objPHPExcel->getActiveSheet()->getStyle('L8')->applyFromArray(array('font' => Style_Font1(14,"ffff00",true)));
                $objPHPExcel->getActiveSheet()->getStyle('B'.$st_col.':'.'M'.$st_col)->applyFromArray(array('font' => Style_Font1(10,"ebf1de",true)));
                $objPHPExcel->getActiveSheet()->getStyle('B'.$st_dat.':'.'M'.$count_data)->applyFromArray(array('font' => Style_Font1(10,"000005",false,false)));

                $objPHPExcel->getActiveSheet()->getStyle('B'.($count_data+3) )->applyFromArray(array('font' => Style_Font1(10,"000000",false,true)));
                $objPHPExcel->getActiveSheet()->getStyle( 'B'.($count_data+4).':'.'D'.($count_data+6) )->applyFromArray(array('font' => Style_Font1(9,"000000",true)));


                $objPHPExcel->getActiveSheet()->getStyle('B3:I8')->applyFromArray(array('fill' => Style_Fill('ffffff')));
                $objPHPExcel->getActiveSheet()->getStyle('B2:M2')->applyFromArray(array('fill' => Style_Fill('0f243e')));
                //$objPHPExcel->getActiveSheet()->insertNewRowBefore(3,1);

                $objPHPExcel->getActiveSheet()->getStyle('J3'.':'.$col_name[$count_index]."4")->applyFromArray(array('fill' => Style_Fill('0f243e')));
                
                $objPHPExcel->getActiveSheet()->getStyle('J5'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('b8cce4')));
                $objPHPExcel->getActiveSheet()->getStyle('L5'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('16365c')));
                $objPHPExcel->getActiveSheet()->getStyle('L6'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('16365c')));
                $objPHPExcel->getActiveSheet()->getStyle('L7'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('16365c')));
                $objPHPExcel->getActiveSheet()->getStyle('L8'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('16365c')));
                $objPHPExcel->getActiveSheet()->getStyle('M5'.':'.$col_name[$count_index]."8")->applyFromArray(array('fill' => Style_Fill('b8cce4')));

                $objPHPExcel->getActiveSheet()->getStyle('B'.$st_col.':'.$col_name[$count_index].$st_col)->applyFromArray(array('fill' => Style_Fill('0f243e')));


                $objPHPExcel->getActiveSheet()->getStyle('E5:I6')
                                              ->applyFromArray(array(
                                                'borders' => array('bottom'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'0f243e'))));
                // $objPHPExcel->getActiveSheet()->getStyle('L5:L8')
                //                               ->applyFromArray(array(
                //                                 'borders' => array('allborders'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'ff0000'))));               
                // $objPHPExcel->getActiveSheet()->getStyle('B3:I8')
                //                               ->applyFromArray(array(
                //                                 'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));  
                $objPHPExcel->getActiveSheet()->getStyle('J3:M4')
                                              ->applyFromArray(array(
                                                'borders' => array('left'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'0f243e'))));                                  
                $objPHPExcel->getActiveSheet()->getStyle('J5:M8')
                                              ->applyFromArray(array(
                                                'borders' => array('inside'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'d9d9d9'))));
                $objPHPExcel->getActiveSheet()->getStyle('J3:M8')
                                              ->applyFromArray(array(
                                                'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'0f243e')))); 
...
$objPHPExcel->getActiveSheet()->getStyle('M'.$st_dat.':'.'M'.$count_data)
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');
$objPHPExcel->getActiveSheet()->getStyle('L'.'5'.':'.'L'.'7')
                              ->getNumberFormat()->setFormatCode('_-* #,##0_-;[Red](#,##0)_-;_-* "-"??_-;_-@_-');
...
$objPHPExcel->getActiveSheet()->getStyle('L'.'7')
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-'); 
$objPHPExcel->getActiveSheet()->getStyle('L'.'8')
                              ->getNumberFormat()->setFormatCode('_-* #,##0_-;[Red](#,##0)_-;_-* "-"??_-;_-@_-'); 
...
//                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[13])->setWidth('14.29');#M
                ...
                Style_Alignment('E7:I7',3, false, $objPHPExcel);
                Style_Alignment('J3:M4',3, false, $objPHPExcel);
...
function Style_Font($size=11, $color='FFFFFF', $bol=false, $ita=false, $fname='Century Gothic') {
...
function Style_Font1($size=11, $color='FFFFFF', $bol=false, $ita=false, $fname='Calibri') {
