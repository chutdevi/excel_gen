...
#========================================================================================================================  Put field ====================================================================================        
            if( $sheetIndex == 'defect' ) 
            {
                ...
                $style_layout['targ'] = array('S' ,'AC' );
                $style_layout['cost'] = array('K' ,'Q' );
                $style_layout['summ'] = array('S' ,'AC');
                $style_layout['rm']   = array('AE','AQ');
                $style_layout['ma']   = array('AS','CC');
                $style_layout['as']   = array('CE','CR');
                $style_layout['di']   = array('CT','DG');
                $style_layout['pe']   = array('DI','DN');
                $style_layout['oh']   = array('DP','DY');
            ...
            #====================================================================== เส้นตารางข้อมูล =============================================================================# 
                ...
                $objPHPExcel->getActiveSheet()->getStyle( $style_layout['summ'][0] . $st_dat . ':' . $style_layout['summ'][1].$count_data )
                                              ->applyFromArray(array(
                                                'borders' => array('inside'   => Style_border(PHPExcel_Style_Border::BORDER_HAIR ,'3e4241'))));
            ...
            #======================================================================== กำหนดขนาด คอลัมป์ ========================================================# 
                 ...
                 $objPHPExcel->getActiveSheet()->getColumnDimension('DZ')->setWidth('2.71'); 
            ...
            #======================================================================== การ input ========================================================================================    
                foreach ( $list_act_report[$sheetIndex][0] as $key => $val ) 
                {
...

                    {
                        ...
                        elseif ( $key == 'BK' || $key == 'RMM' || $key == 'MAA' || $key == 'ASD' || $key == 'DIC' || $key == 'PEE' || $key == 'OHR'  ) $objPHPExcel->getActiveSheet()->setCellValue($col_name[$i++].$st_col,  '' ) ;
            ...
            #======================================================================== จัดตำแหน่ง ข้อมูล ====================================================================================         
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('S'  . '19',  'SUM (pcs.)' );
                 $objPHPExcel->getActiveSheet()->setCellValue('T'  . '19',  'ê' );
                 $objPHPExcel->getActiveSheet()->setCellValue('U'  . '19',  'SUM (ppm.)' );
                 $objPHPExcel->getActiveSheet()->setCellValue('V'  . '19',  'è' );                                                                          
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('AC' . $st_col, 'MA + PE'."\n"."(Pcs.)");
                    ...
                    foreach ( range(29, 41) as $sum )   $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")");
                    foreach ( range(43, 79) as $sum )   $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")");
                    foreach ( range(81, 94) as $sum )   $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")");

                    foreach ( range(96,  109) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")");  
                    foreach ( range(111, 116) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")"); 
                    foreach ( range(118, 127) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '21',  "=SUBTOTAL(9,". $col_name[$sum] . $st_dat .":". $col_name[$sum] .$count_data.")"); 

                    foreach ( range(21, 27) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );
                    foreach ( range(29, 41) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );
                    foreach ( range(43, 79) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );
                    foreach ( range(81, 94) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );

                    foreach ( range(96,  109) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' );  
                    foreach ( range(111, 116) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' ); 
                    foreach ( range(118, 127) as $sum )  $objPHPExcel->getActiveSheet()->setCellValue( $col_name[$sum] . '19',  "=(". $col_name[$sum] . "21" ."/". '$T$21)*1000000' ); 
                    ...
                    foreach ( range(5, 13)   as $sum )  

                        {
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('AA'. $sum)->setConditionalStyles(array($objConditional1));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('BB'.$sum)->setConditionalStyles(array($objConditional2));
                                      
                        }                       
                                            
            #======================================================================== พิเศษ ========================================================================================
                       $objPHPExcel->getActiveSheet()->getStyle('AD2:DZ2')->getAlignment()->setTextRotation(-90);
                       $objPHPExcel->getActiveSheet()->getStyle('AD2:DZ2')->applyFromArray(array('font' => Style_Font(28,"FF0000",True,False,'Arial Rounded MT Bold')));
                       $objPHPExcel->getActiveSheet()->setCellValue('AR'  . '2', 'RM' );
                       $objPHPExcel->getActiveSheet()->setCellValue('CD'  . '2', 'MA' );
                       $objPHPExcel->getActiveSheet()->setCellValue('CS'  . '2', 'AS' );
                       $objPHPExcel->getActiveSheet()->setCellValue('DH'  . '2', 'PD4');
                       $objPHPExcel->getActiveSheet()->setCellValue('DO'  . '2', 'PE' );
                       $objPHPExcel->getActiveSheet()->setCellValue('DZ'  . '2', 'OTHER' );
                       Style_Alignment('AD2:DZ2',2, False, $objPHPExcel); 

                            foreach (array('AR', 'CD', 'CS', 'DH', 'DO', 'DZ') as $ind_col )  

                            {
                                $objPHPExcel->getActiveSheet()->getColumnDimension($ind_col)->setWidth('8.71');  
                                $objPHPExcel->getActiveSheet()->mergeCells( $ind_col . '2' . ':' .$ind_col . '13' );
            ...
            #======================================================================== กำหนด ฟ้อร์น และ สี ==================================================================================== 
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('S15:DY15') ->applyFromArray(array('font' => Style_Font(36,"000000",True,False,'Arial Rounded MT Bold'))); 
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('U3:AC13')->applyFromArray(array('font' => Style_Font(11,"000000",True,False)));
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('S19:DY21')->applyFromArray(array('font' => Style_Font(12,"000000",True,False,'Arial Rounded MT Bold')));
                   ...
                   $objPHPExcel->getActiveSheet()->getStyle('T19')->applyFromArray(array('font' => Style_Font(24,"000000",True,False,'Wingdings')));
                   $objPHPExcel->getActiveSheet()->getStyle('V19')->applyFromArray(array('font' => Style_Font(24,"000000",True,False,'Wingdings')));
            ...
            #======================================================================== กรุป คอลัมป์  ==================================================================================== 
                   ...
                   foreach ( range(28,  128) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 1);                  
                   foreach ( range(28,  41)  as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(43,  79)  as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(81,  94)  as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(96,  109) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(111, 116) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
                   foreach ( range(118, 127) as $index) Style_group_Col($col_name, $index, $objPHPExcel, 2 );
