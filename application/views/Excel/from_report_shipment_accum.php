     ...
     if(count($list_act_report[$key]) > 0 )
         { 
                   if ($key == 'weekly_shipment') 
                   {
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('A4:'.$col_name[$Onday+10].'4')->applyFromArray(array('font'    => Style_Font(11, 'FFFFFF', true, 'Calibri Light')));
                    $objPHPExcel->getActiveSheet()->getStyle('A6:'.$col_name[$Onday+10].(count( $list_act_report[$key] )+5))->applyFromArray(array('font'    => Style_Font(10, '000000', false, 'Calibri Light')));
                    $objPHPExcel->getActiveSheet()->getStyle('A4:'.$col_name[$Onday+10].'5')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'000000'))));
                    // $objPHPExcel->getActiveSheet()->getStyle("A1")->getFont()->setBold(true)
                    //             ->setName('Consolas')
                    //             ->setSize(11)
                    //             ->getColor()->setRGB('FFFFFF');
                    $objPHPExcel->getActiveSheet()->getStyle('A5:'.$col_name[$Onday+10].'5')->applyFromArray(array('fill'    => Style_Fill('E5E7E9')));
                    $startData = 6;
                    $r = 6;
                                                        ...
                                                        else
                                                        {
                                                         if ( holiday(substr($rowData,1,strlen($key)-1), $holiday) )
                                                                $objPHPExcel->getActiveSheet()
                                                                            ...
                                                                            ->applyFromArray( array( 'fill' => Style_Fill('fde9d9') ) );                                                           
                                                        }
                                                    } 
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('A1', "WEEKLY SHIPMENT REPORT ".strtoupper(date('Y')));
...
#126180
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('A1')->applyFromArray(array('font'    => Style_Font(22, 'FFFFFF', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('A3')->applyFromArray(array('font'    => Style_Font(16, '000000', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('I1')->applyFromArray(array('font'    => Style_Font(16, 'FFFFFF', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('I3')->applyFromArray(array('font'    => Style_Font(14, 'FFFFFF', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('J1')->applyFromArray(array('font'    => Style_Font(14, 'FFFFFF', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('J2:L2')->applyFromArray(array('font' => Style_Font(12, '000000', true, 'Calibri Light')));
                            //$objPHPExcel->getActiveSheet()->getStyle('M1:'.$col_name[$Onday+10].'1')->applyFromArray(array('font' => Style_Font(13, 'FFFFFF', true, 'Consolas')));
                            $objPHPExcel->getActiveSheet()->getStyle('M2:'.$col_name[$Onday+10].'2')->applyFromArray(array('font' => Style_Font(13, '000000', true, 'Calibri Light')));
                            $objPHPExcel->getActiveSheet()->getStyle('M3:'.$col_name[$Onday+10].'3')->applyFromArray(array('font' => Style_Font(12, '001933', true, 'Calibri Light')));

                            $objPHPExcel->getActiveSheet()->getStyle('A1:A2')->applyFromArray(array('fill'    => Style_Fill('1A5276')));
                            $objPHPExcel->getActiveSheet()->getStyle('A3')->applyFromArray(array('fill'    => Style_Fill('F2F3F4')));
                            $objPHPExcel->getActiveSheet()->getStyle('I1:I3')->applyFromArray(array('fill'    => Style_Fill('5499C7')));
                            $objPHPExcel->getActiveSheet()->getStyle('J1:L1')->applyFromArray(array('fill'    => Style_Fill('669900')));
                            $objPHPExcel->getActiveSheet()->getStyle('J2:L2')->applyFromArray(array('fill'    => Style_Fill('e2efda')));
                    ...
                    //         foreach (range('B', 'E') as $key) $objPHPExcel->getActiveSheet()->getColumnDimension($key)->setWidth('10');
                            ...
                            foreach (range('I', 'L') as $key) $objPHPExcel->getActiveSheet()->getColumnDimension($key)->setWidth('20');
...
//echo date('d', strtotime($Tday)) . "-" . $Nday . " ---> " . $col[$indexSun] . ":" . $col[($d+11)] . "<hr>";  
        ...
        {            
            ...
            $objPHPExcel->getActiveSheet()->getStyle($col[$indexSun].'6'. ":" . $col[$indexSun].$end_row)->applyFromArray(array('fill'    => Style_Fill('ccecff'))); 
            $kla = 99;       
        }
        else
        {            
