...
$getfirstdate = 1;
//echo $chkfirstday;  echo $getfirstdate; exit;
...
foreach ($title as $inTil => $til) 
{
    ...
    {   
        if ($til == 'PCL QCD Daily Report') { 
                ...
                for($i = ($count_data+4); $i < ($count_data+11); $i++){
                	$temp = 'A'.$i;
                	if($i < ($count_data+6)){
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('A'.($count_data+6).':'.'CK'.($count_data+6));
                $objPHPExcel->getActiveSheet()->getStyle('A'.($count_data+3))->applyFromArray(array('fill' => Style_Fill('1f497d')));
                $objPHPExcel->getActiveSheet()->getStyle('A'.($count_data+6))->applyFromArray(array('fill' => Style_Fill('1f497d')));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('AP3:CK4')->applyFromArray(array('fill' => Style_Fill('fde9d9'))); //LIGHT BROWN COLOR
