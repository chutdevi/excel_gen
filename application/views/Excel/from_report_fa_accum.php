     ...
     if(count($list_act_report[$key]) > 0 )
         { 
                   if ($key == 'fa_summary') 
                   {
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('A3:'.$col_name[56].'4')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFF99'))));
                    // $objPHPExcel->getActiveSheet()->getStyle("A1")->getFont()->setBold(true)
                    //             ->setName('Consolas')
                    //             ->setSize(11)
                    //             ->getColor()->setRGB('FFFFFF');
                    $objPHPExcel->getActiveSheet()->getStyle('A4:'.$col_name[56].'4')->applyFromArray(array('fill'    => Style_Fill('feffd5')));
                    $startData = 5;
                    $r = 5;
        ...
        //echo $Montlast.$Daylast;exit;
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValue('G1', "Accumulate Staff \n [man.] ");
...
#126180
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('A1:F1')->applyFromArray(array('fill'    => Style_Fill('FFFF67')));
                            $objPHPExcel->getActiveSheet()->getStyle('A2:F2')->applyFromArray(array('fill'    => Style_Fill('FFFF99')));
                            $objPHPExcel->getActiveSheet()->getStyle('A3:F3')->applyFromArray(array('fill'    => Style_Fill('FFFF99')));
                            $objPHPExcel->getActiveSheet()->getStyle('G1:N1')->applyFromArray(array('fill'    => Style_Fill('66FFCC')));
                            $objPHPExcel->getActiveSheet()->getStyle('G2:N2')->applyFromArray(array('fill'    => Style_Fill('99FFCC')));
                            $objPHPExcel->getActiveSheet()->getStyle('G3:N3')->applyFromArray(array('fill'    => Style_Fill('CCFFCC')));
                            $objPHPExcel->getActiveSheet()->getStyle('K1:N1')->applyFromArray(array('fill'    => Style_Fill('66FFCC')));
                            $objPHPExcel->getActiveSheet()->getStyle('K2:L2')->applyFromArray(array('fill'    => Style_Fill('99FFCC')));
                            $objPHPExcel->getActiveSheet()->getStyle('M1:BE1')->applyFromArray(array('fill'    => Style_Fill('7A5C99')));
                            $objPHPExcel->getActiveSheet()->getStyle('M2:BE2')->applyFromArray(array('fill'    => Style_Fill('B1A0C7')));
                            $objPHPExcel->getActiveSheet()->getStyle('M3:BE3')->applyFromArray(array('fill'    => Style_Fill('E4DFEC')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('H1:'.'J1')->applyFromArray(array(
                                                                      'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));
                            $objPHPExcel->getActiveSheet()->getStyle('Z2:'.'BE2')->applyFromArray(array(
                                                                      'borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));
