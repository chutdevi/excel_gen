...
foreach ($title as $inTil => $til) 
{
    ...
    {   
        if ($til == 'QCD Production Report') { 
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A68:AU68')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A76:AU76')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A80:AU80')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A101:AU101')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A106:AU106')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('A'.($count_data+12).':'.'AU'.($count_data+12));
