...
foreach ($title as $inTil => $til) 
{
    ...
    {   
        if ($til == 'PCL QCD Daily Report') { 
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A71:CE71')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A77:CE77')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A81:CE81')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A103:CE103')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A109:CE109')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                 $objPHPExcel->getActiveSheet()->getStyle('A110:CE110')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('A'.($count_data+13).':'.'CE'.($count_data+13));
...
//exit;
            ...
            $i   = 0;     
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B53:CK55')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
