...
//exit;
            ...
            $count_index =  count($list_act_report[$sheetIndex][0]) - 3;
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B51:CK51')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('F3:'.'F4');
                //
                $objPHPExcel->getActiveSheet()->mergeCells('A6:'.'A51');
                $objPHPExcel->getActiveSheet()->mergeCells('C6:'.'C22');
                $objPHPExcel->getActiveSheet()->mergeCells('C23:'.'C51');
                //
