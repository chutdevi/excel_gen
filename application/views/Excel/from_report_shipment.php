...
//echo date('Y-M-d', strtotime(date('Y')."-".date('M')."-".(date('d')+1))); exit;
    ...
    $objPHPExcel->setActiveSheetIndex($inTil)->setCellValue('A1', 'DAILY SHIPMENT REPORT');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('L2')->applyFromArray(array( 'font' => Style_Font(9, '660033', TRUE)));
