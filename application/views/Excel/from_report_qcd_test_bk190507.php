...
foreach ($title as $inTil => $til) 
{
    ...
    if ($count_data - 4  > 0) 
    {   
        if ($til == 'PCL QCD Daily Report Test') { 
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A49:CE49')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A61:CE61')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A63:CE63')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A65:CE65')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A67:CE67')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A75:CE75')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A79:CE79')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A99:CE99')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A100:CE100')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A104:CE104')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                $objPHPExcel->getActiveSheet()->getStyle('A105:CE105')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
...
//exit;
            ...
            $count_index =  count($list_act_report[$sheetIndex][0]) - 3;
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B50:CK50')->applyFromArray(array('borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'808080'))));
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('F3:'.'F4');
                //
                $objPHPExcel->getActiveSheet()->mergeCells('A6:'.'A50');
                $objPHPExcel->getActiveSheet()->mergeCells('C6:'.'C22');
                $objPHPExcel->getActiveSheet()->mergeCells('C23:'.'C50');
                //
