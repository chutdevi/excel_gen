...
#========================================================================================================================  Put field ====================================================================================        
            ...
            #======================================================================== จัดตำแหน่ง ข้อมูล ====================================================================================     
                ...
                //echo date('t F Y', strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) ; exit;
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('C'  . '3', 'DEFECT MONTHLY REPORT');
                 $objPHPExcel->getActiveSheet()->setCellValue('C'  . '6', '( Accumulate Ng ' . date('01 F' , strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) . ' to ' . date('t F', strtotime( "$mnt month", strtotime( date('01-m-Y') ) ) ) . " )" );
