     ...
     if(count($list_act_report[$sheetIndex]) > 0 )
         { 
                   ...
                   $objPHPExcel->setActiveSheetIndex($indSheet);
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle(('D'.$st_cal.':'.$col_name[15].$st_cal))
                                ->getAlignment()
                                ->setWrapText(true)
                                ->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)
                                ->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
                    ...
                    $objPHPExcel->getActiveSheet()
                                ->getStyle('D9:'.$col_name[15].(count( $list_act_report[$sheetIndex] )+8))
                                ->getAlignment()
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[15].'6')->applyFromArray(array('fill'    => Style_Fill($colhead)));
                    $objPHPExcel->getActiveSheet()->getStyle('D6:'.$col_name[15].'6')->applyFromArray(array('font'    => Style_Font(10, 'FFFFFF', true, 'Arial Narrow')));
                    $objPHPExcel->getActiveSheet()->getStyle('D9:'.$col_name[15].(count( $list_act_report[$sheetIndex] )+8))->applyFromArray(array('font'    => Style_Font(11, '000000', false, 'Calibri')));
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('D8:'.$col_name[15].'8')->applyFromArray(array('fill'    => Style_Fill('b3cccc')));
...
#126180
                      //      $objPHPExcel->getActiveSheet()->getStyle('G2:L2')->applyFromArray(array('font'    => Style_Font(14, '000000', true, 'Calibri')));
                            ...
                            $objPHPExcel->getActiveSheet()->getStyle('B2:'.'Q'.($cu_dat+10))->applyFromArray(array(
                                                                     'borders' => array('outline' => Style_border(PHPExcel_Style_Border::BORDER_THICK,'000000'))));
                            $objPHPExcel->getActiveSheet()->getStyle('D9:'.'P'.($cu_dat+9))->applyFromArray(array(
