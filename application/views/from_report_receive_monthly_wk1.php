...
//                 $objDrawing->setName('pg');
//                 $objDrawing->setDescription('pg');
//                 $objDrawing->setPath('../views/img/TBKK.png');
...
#========================================================================================================================  Put field ====================================================================================        
            if( $sheetIndex == 'receive_monthly' ) 
            {
                ...
                //$objPHPExcel->getActiveSheet()->getRowDimension( '3:8' )->setRowHeight( 20 );
                ...
                $objPHPExcel->getActiveSheet()->setAutoFilter('B'.($st_col+1).':'.'O'.($st_col+1));                


                $objPHPExcel->getActiveSheet()->getStyle('B2:'.$col_name[$count_index].($count_data+1))
                                              ->applyFromArray(array(
                                                'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'ffffff')))); 

                //echo $row; exit;       
                //var_dump($list_act_report[$sheetIndex][0]);exit();            
...
#========================================================================================================================  Put data ====================================================================================                
                    ...
                    foreach ($value as $body => $val) 
                    {
                            $objPHPExcel->setActiveSheetIndex($ind)->setCellValue($col_name[$col++].($row), $val);
                                ...
                                if($val == "" && $body == 'PD' && $look_data === 0)
                                    $look_data = $row;
                            if ( ($body == 'PLAN CURRENT AMOUNTT' && $value[$body] > 0) || ( $body == 'PLAN_AMOUNT' && $value[$body] > 0) ) 
                            {
                                    if ($value['SOURCE_CD'] == 'T00100' || $value['SOURCE_CD'] == 'M50050' || $value['SOURCE_CD'] == 'T10400' ) {
                                       ...
                                       // $amt = $val * $rate[2]['CURRENCY_RATE'];
                                        ...
                                        $objPHPExcel->getActiveSheet()->getStyle($col_name[$col-1].$row)
                                                                                                 ->applyFromArray(array('font' => Style_Font(21, 'ff0000', false, 'Consolas')));                                                   
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('B2', 'WEEKLY FORECAST RECEIVING REPORT');
                $objPHPExcel->getActiveSheet()->setCellValue('C8',  $H_lastM);
                $objPHPExcel->getActiveSheet()->setCellValue('J8',  'SUMMARY TOTAL');
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('J9',  'PLAN NEXT MONTH');
                $objPHPExcel->getActiveSheet()->setCellValue('J10', 'PRICE NEXT MONTH');
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('L9',  "=SUBTOTAL(9,N". $st_dat .":N".$count_data.")");
                $objPHPExcel->getActiveSheet()->setCellValue('L10', "=SUBTOTAL(9,O". $st_dat .":O".$count_data.")");
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('O9',  "Pcs.");
                $objPHPExcel->getActiveSheet()->setCellValue('O10',  "Thb.");
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B2')->applyFromArray(array('font' => Style_Font(38,"ffffff")));
                $objPHPExcel->getActiveSheet()->getStyle('C8')->applyFromArray(array('font' => Style_Font(31,"ffffff")));

                
                Style_Alignment('C8:H10',3, false, $objPHPExcel);
                Style_Alignment('B2:J7',3, false, $objPHPExcel);

                $objPHPExcel->getActiveSheet()->getStyle('J8')->applyFromArray(array('font' => Style_Font(24,"ffffff")));
                $objPHPExcel->getActiveSheet()->mergeCells('J8:O8');
                Style_Alignment('J8:O8',3, false, $objPHPExcel);
                $objPHPExcel->getActiveSheet()->getStyle('J9:O9')->applyFromArray(array('font' => Style_Font(14,"000000")));
                $objPHPExcel->getActiveSheet()->getStyle('L9:N9')->applyFromArray(array('font' => Style_Font(14,"ff0000")));
                $objPHPExcel->getActiveSheet()->getStyle('J10:O10')->applyFromArray(array('font' => Style_Font(14,"000000")));
                $objPHPExcel->getActiveSheet()->getStyle('L10:N10')->applyFromArray(array('font' => Style_Font(14,"ff0000")));
                ...
                $objPHPExcel->getActiveSheet()->getStyle('B2:O7')->applyFromArray(array('fill' => Style_Fill('0f243e')));
                $objPHPExcel->getActiveSheet()->getStyle('B2:O7')->applyFromArray(array('borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));
                
                $objPHPExcel->getActiveSheet()->getStyle('B8:I10')->applyFromArray(array('fill' => Style_Fill('366092')));
                $objPHPExcel->getActiveSheet()->getStyle('B8:I10')->applyFromArray(array('borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));
                //$objPHPExcel->getActiveSheet()->insertNewRowBefore(3,1);

                //$objPHPExcel->getActiveSheet()->getStyle('J8'.':'.$col_name[$count_index]."1")->applyFromArray(array('fill' => Style_Fill('ff0000')));
                $objPHPExcel->getActiveSheet()->getStyle('J8:O8')->applyFromArray(array('fill' => Style_Fill('31869b'))); //background SUMMARY TOTAL
                $objPHPExcel->getActiveSheet()->getStyle('J8:O8')->applyFromArray(array('borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));
                $objPHPExcel->getActiveSheet()->getStyle('J9:O9')->applyFromArray(array('fill' => Style_Fill('b7dee8')));
                $objPHPExcel->getActiveSheet()->getStyle('J9:O9')->applyFromArray(array('borders' => array('allborders'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));
                $objPHPExcel->getActiveSheet()->getStyle('J10:O10')->applyFromArray(array('fill' => Style_Fill('b7dee8')));
                $objPHPExcel->getActiveSheet()->getStyle('J10:O10')->applyFromArray(array('borders' => array('allborders'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'ffffff'))));
                $objPHPExcel->getActiveSheet()->getStyle('B'.$st_col.':'.$col_name[$count_index].$st_col)->applyFromArray(array('fill' => Style_Fill('16365c')));


                 // $objPHPExcel->getActiveSheet()->getStyle('C4:I4')
                 //                                ->applyFromArray(array(
                 //                                  'borders' => array('bottom'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'ffffff'))));

                // $objPHPExcel->getActiveSheet()->getStyle('C7:H8')
                //                                ->applyFromArray(array(
                //                                  'borders' => array('bottom'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'e91e63'))));

                $objPHPExcel->getActiveSheet()->getStyle('J8:'.$col_name[$count_index].'9')
                                              ->applyFromArray(array(
                                                'borders' => array('none'   => Style_border(PHPExcel_Style_Border::BORDER_THIN,'e91e63'))));
                $objPHPExcel->getActiveSheet()->getStyle('J11:'.$col_name[$count_index].'10')
                                              ->applyFromArray(array(
...
$objPHPExcel->getActiveSheet()->getStyle('O'.$st_dat.':'.'O'.$count_data)
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');

$objPHPExcel->getActiveSheet()->getStyle('L'.'4'.':'.'L'.'9')
                              ->getNumberFormat()->setFormatCode('_-* #,##0_-;[Red](#,##0)_-;_-* "-"??_-;_-@_-');
$objPHPExcel->getActiveSheet()->getStyle('L'.'7')
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');                              
$objPHPExcel->getActiveSheet()->getStyle('L'.'9')
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');
$objPHPExcel->getActiveSheet()->getStyle('L'.'10')
                              ->getNumberFormat()->setFormatCode('_-* #,##0.00_-;[Red](#,##0.00)_-;_-* "-"??_-;_-@_-');  
                ...
                $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[10])->setWidth('20');   #L
                ...
                Style_Alignment('C2:C7',3, false, $objPHPExcel);
                ...
                $objPHPExcel->getActiveSheet()->mergeCells('B2:'.'J7');
                $objPHPExcel->getActiveSheet()->mergeCells('C8:'.'I10');
                ...
                //{
                    //$objPHPExcel->getActiveSheet()->mergeCells('J7'.$r.':'.'O7'.$r);  
