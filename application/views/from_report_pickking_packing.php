...
#========================================================================================================================  Put field ====================================================================================        
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'O2:S5' )
                                              ->applyFromArray(array(
                                                'borders' => array('outline'   => Style_border(PHPExcel_Style_Border::BORDER_THICK,'000000')))); 
                 ...
                 Style_Alignment('H1:S5',3, false, $objPHPExcel);
                 Style_Alignment('G3',3, false, $objPHPExcel);

                 Style_Alignment( 'B'.$st_dat.':'.$col_name[4].$count_data ,3, false, $objPHPExcel);
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'O2:S5' )
                 ...
                 $objPHPExcel->getActiveSheet()->getStyle('B8:S8')->applyFromArray(array('font' => Style_Font(18,"000000",true,false)));
                 $objPHPExcel->getActiveSheet()->getStyle('G8:R8')->applyFromArray(array('font' => Style_Font(12,"000000",true,false)));
                 ...
                 foreach( array( array(6,8), array(9,11), array(12,14), array(15,17) )  as  $ty )
                 {
                 ...
                 foreach( array(1, 2, 3, 4, 5, $count_index)  as  $ty )
                 {
...
//exit;
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[6] . 8, "( PERIOD 1-2 ) 05:00 น. - 10:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[9] . 8, "( PERIOD 3-4 ) 13:00 น. - 16:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[12]. 8, "( PERIOD 5-6 ) 18:00 น. - 19:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[15]. 8, "( PERIOD 7-8 ) 20:00 น. - 00:00 น.");
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue('O4', 'CHECKDOCUMENTS BY'."\n".'เช็คเอกสารโดย');

                 $objPHPExcel->getActiveSheet()->setCellValue('Q4', 'PART / FG PREPARED BY'."\n".'จัดเตรียมงาน / จัดส่งโดย');
                 $objPHPExcel->getActiveSheet()->setCellValue('S4', 'APPROVE BY'."\n".'อนุมติโดย');

                 $objPHPExcel->getActiveSheet()->getStyle('O4:S4')->getAlignment()->setWrapText(true);
                ...
                //$objPHPExcel->getActiveSheet()->getColumnDimension($col_name[$count_index])->setWidth('2.71');     #A
                 ...
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[4])->setWidth('27.71');    #K
                 $objPHPExcel->getActiveSheet()->getColumnDimension($col_name[5])->setWidth('14.71');    #K
               ...
               $objPHPExcel->getActiveSheet()->mergeCells('O4:'.'P5');

               $objPHPExcel->getActiveSheet()->mergeCells('Q2:'.'R3');
               $objPHPExcel->getActiveSheet()->mergeCells('Q4:'.'R5');
