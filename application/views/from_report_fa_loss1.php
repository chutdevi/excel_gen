     ...
     if(count($list_act_report[$key]) > 0 )
         {
                   ...
                   if ($key == 'fa_loss') 
               {
                    ...
                    $objPHPExcel->getActiveSheet()->setAutoFilter('A4:'.$col_name[7].'4');
                    $objPHPExcel->getActiveSheet()
                    ...
                    $objPHPExcel->getActiveSheet()->getStyle('A3:'.$col_name[7].'3')->applyFromArray(array('fill'    => Style_Fill('b3d9ff')));
                    $objPHPExcel->getActiveSheet()->getStyle('A3:'.$col_name[7].'3')->applyFromArray(array('font'    => Style_Font(11, '000000', true, 'Calibri')));
                    $objPHPExcel->getActiveSheet()->getStyle('A5:'.$col_name[7].(count( $list_act_report[$key] )+5))->applyFromArray(array('font'    => Style_Font(10, '000000', false, 'Calibri')));
                    $objPHPExcel->getActiveSheet()->getStyle('A3:'.$col_name[7].'4')->applyFromArray(array('borders' => array('allborders' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'FFFFFF'))));
                    // $objPHPExcel->getActiveSheet()->getStyle("A1")->getFont()->setBold(true)
                    //             ->setName('Consolas')
                    //             ->setSize(11)
                    //             ->getColor()->setRGB('FFFFFF');
                    $objPHPExcel->getActiveSheet()->getStyle('A4:'.$col_name[7].'4')->applyFromArray(array('fill'    => Style_Fill('D9D9D9')));
                    $startData = 5;
                    $r = 5;
        ...
        //echo $Montlast.$Daylast;exit;
                                ...
                                $objPHPExcel->getActiveSheet()->getStyle('A3:H3')->applyFromArray(array('fill'    => Style_Fill('669999')));
