...
//============================================================================================= date =================================================================================
//equire_once dirname(__FILE__) . '/Classes/PHPExcel.php';
//$rendererLibrary = 'tcPDF5.9';
//$mPDFLibraryPath = dirname(__FILE__).'/Classes/libraries/PDF/' . $rendererLibrary;    
                                   ...
                                   $objPHPExcel->setActiveSheetIndex($indSheet);
                                    ...
                                    //var_dump($list_act_report); exit;
                                            ...
                                            $objPHPExcel->getActiveSheet()->getStyle('B13:'.'J'.($r))->applyFromArray(array('font'    => Style_Font(28, '002d4d', false, 'Courier New')));
                                             ...
                                             $objPHPExcel->getActiveSheet()->getStyle('B6:F6')->applyFromArray(array(
                                   ...
                                   $objPHPExcel->setActiveSheetIndex($indSheet);
                                    ...
                                    //var_dump($list_act_report); exit;
                                            ...
                                            $objPHPExcel->getActiveSheet()->getStyle('B13:'.'L'.($r))->applyFromArray(array('font'    => Style_Font(28, '002d4d', false, 'Courier New')));
                                             ...
                                             $objPHPExcel->getActiveSheet()->getStyle('B7:F7')->applyFromArray(array(
                                                                                      'borders' => array('bottom' => Style_border(PHPExcel_Style_Border::BORDER_THIN,'000000'))));
...
// Redirect output
            ...
            $str_vend .= $vend['VEND_CD'].'-'. date('dmy',strtotime(" + 1 day")) . "," ;

            $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
            $objWriter->save('G:/file_export/request_sheet/'.$vend['VEND_CD'].'-'.date('dmy',strtotime(" + 1 day")).'.xlsx');
