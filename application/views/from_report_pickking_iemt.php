...
#========================================================================================================================  Put field ====================================================================================        
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'N2:R5' )
                 ...
                 Style_Alignment('O6',1, false, $objPHPExcel);
                ...
                $objPHPExcel->getActiveSheet()->getStyle( 'N2:R5' )
                 ...
                 $objPHPExcel->getActiveSheet()->getStyle('O6')->applyFromArray(array('font' => Style_Font(14,"000000",true,false)));
                 ...
                 $objPHPExcel->getActiveSheet()->mergeCells('O6:Q7');
...
//exit;
                 ...
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[5] . 8, "( PERIOD 2 ) 10:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[8] . 8, "( PERIOD 3 ) 15:00 น.");
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[11]. 8, "( PERIOD 4 ) 23:30 น.");
                 $dateUse_N = date('Y/m/d', strtotime("+1 day", strtotime($de_date) ) ) ;
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[14]. 6, $dateUse_N);
                 $objPHPExcel->getActiveSheet()->setCellValue($col_name[14]. 8, "( PERIOD 1 ) 04:30 น.");
                 ...
                 $de_cust = (  $de_cust == 'IEMT-SUM' ) ? 'IEMT' :  $de_cust;
