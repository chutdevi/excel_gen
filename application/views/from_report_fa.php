...
//exit;
       ...
       //   foreach (range('T', 'Z') as $key) $objPHPExcel->getActiveSheet()->getColumnDimension($key)->setWidth('12'); #ขนาดคอลัม    
         ...
         // $objPHPExcel->getActiveSheet()->getStyle('R2:S2')->getNumberFormat()->setFormatCode('hh:mm:ss');
          ...
          $objPHPExcel->getActiveSheet()->setCellValue('AC3', "[G]\n Model Change,Mold Change - in Plan");
          $objPHPExcel->getActiveSheet()->setCellValue('AD3', "[H]\n Tooling Change / Lot no. change/Tip/Sleeve - on Plan");
          $objPHPExcel->getActiveSheet()->setCellValue('AE3', "[K]\n Break Down - Machine ");
          $objPHPExcel->getActiveSheet()->setCellValue('AF3', "[K1]\n Break Down - Mold (Die Casting)");
          $objPHPExcel->getActiveSheet()->setCellValue('AG3', "[K3]\n Break Down - Tooling");
          $objPHPExcel->getActiveSheet()->setCellValue('AI3', "[L]\n Adjust Program and Condition.");

          $objPHPExcel->getActiveSheet()->setCellValue('AH3', "[L1]\n Adjustment - Mold (Die Casting)");  
